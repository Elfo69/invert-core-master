...
namespace CryptoNote
{
	namespace parameters
	{
		...
		const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX = 0x4edf9; /* inv address prefix */
		...
		const uint64_t MINIMUM_FEE = UINT64_C(10);			  /* 0.000010 inv */
		const uint64_t MINIMUM_FEE_V1 = UINT64_C(100);		  /* 0.000100 inv */
		const uint64_t MINIMUM_FEE_V2 = UINT64_C(1000);		  /* 0.001000 inv */
		const uint64_t MINIMUM_FEE_BANKING = UINT64_C(1000);  /* 0.001000 inv */
		const uint64_t DEFAULT_DUST_THRESHOLD = UINT64_C(10); /* 0.000010 inv */
		...
		const uint32_t DEPOSIT_HEIGHT_V3 = 1;			 /* changed to 1 - deposts v3.0 */
		...
		const uint32_t END_MULTIPLIER_BLOCK = 1; /* legacy deposits */
		...
		const uint64_t UPGRADE_HEIGHT_V3 = 1;	  /* Cryptonight-Fast */
		const uint64_t UPGRADE_HEIGHT_V4 = 1;	  /* MixIn 2 */
		const uint64_t UPGRADE_HEIGHT_V5 = 1;	  /* Deposits 2.0, Investments 1.0 */
		const uint64_t UPGRADE_HEIGHT_V6 = 1;	  /* LWMA3 */
		const uint64_t UPGRADE_HEIGHT_V7 = 1;	  /* Cryptoight invert */
		const uint64_t UPGRADE_HEIGHT_V8 = 1;	  /* LWMA1, CN-GPU, Halving */
		const uint64_t UPGRADE_HEIGHT_A = 52; //6.25 per block
		const uint64_t UPGRADE_HEIGHT_B = 42; //12.5 per block
		const uint64_t UPGRADE_HEIGHT_C = 32; //25 per block
		const uint64_t UPGRADE_HEIGHT_D = 22; //50 per block
		const uint64_t UPGRADE_HEIGHT_E = 11; //100 per block
		const uint64_t UPGRADE_HEIGHT_F = 1; //150 per block
	...
	const uint64_t MAX_BLOCK_REWARD_V1 = (UINT64_C(150) * parameters::COIN);
	const uint64_t MAX_BLOCK_REWARD_V2 = (UINT64_C(100) * parameters::COIN);
	const uint64_t MAX_BLOCK_REWARD_V3 = (UINT64_C(50) * parameters::COIN);
	const uint64_t MAX_BLOCK_REWARD_V4 = (UINT64_C(25) * parameters::COIN);
	const uint64_t MAX_BLOCK_REWARD_V5 = (UINT64_C(12.5) * parameters::COIN);
	const uint64_t MAX_BLOCK_REWARD_V6 = (UINT64_C(6.25) * parameters::COIN);
	const uint64_t REWARD_INCREASE_INTERVAL = (UINT64_C(21900));			   // aprox. 1 month (+ 0.25 inv increment per month)

	const char CRYPTONOTE_NAME[] = "invert";
	const char GENESIS_COINBASE_TX_HEX[] = "";
	const uint32_t GENESIS_NONCE = 28037;
	const uint64_t GENESIS_TIMESTAMP = 1636028723;
	...
	const uint8_t BLOCK_MAJOR_VERSION_7 = 7; /* Cryptonight invert */
	...
	const int P2P_DEFAULT_PORT = 17257;
	const int RPC_DEFAULT_PORT = 14207;
