...
namespace CryptoNote
{
  ...
  uint64_t Currency::baseRewardFunction(uint64_t alreadyGeneratedCoins, uint32_t height) const
  {
    ...
    if (height > CryptoNote::parameters::UPGRADE_HEIGHT_A)
    {
      base_reward = CryptoNote::MAX_BLOCK_REWARD_V6;
    }
    else if (height > CryptoNote::parameters::UPGRADE_HEIGHT_B)
    {
      base_reward = CryptoNote::MAX_BLOCK_REWARD_V5;
    }
    else if (height > CryptoNote::parameters::UPGRADE_HEIGHT_C)
    {
      base_reward = CryptoNote::MAX_BLOCK_REWARD_V4;
    }
    else if (height > CryptoNote::parameters::UPGRADE_HEIGHT_D)
    {
      base_reward = CryptoNote::MAX_BLOCK_REWARD_V3;
    }
    else if (height > CryptoNote::parameters::UPGRADE_HEIGHT_E)
    {
      base_reward = CryptoNote::MAX_BLOCK_REWARD_V2;
    }
    else if (height > CryptoNote::parameters::UPGRADE_HEIGHT_F)
    {
